...
################  testing rightword2vec  #################################

library(wordVectors)
out <- rightword2vec::train_word2vec("../../BLM_project/the_nation_traindata.txt",
...
nearest_to(out$input, out$input[["laquan"]], 20)
nearest_to(out$output, out$output[["laquan"]], 20)
